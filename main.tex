...
\newpage
\section{Coincidence Measurements} % Correlation? 
%\addcontentsline{toc}{section}{Coincidence Measurements}
\input{Sections/exp_coincidences.tex}

%\newpage
%\section{Diffuse Correlation Spectroscopy} 
%\addcontentsline{toc}{section}{Diffuse Correlation Spectroscopy}
\input{Sections/decorrelation.tex}
